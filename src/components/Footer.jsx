          ...
          <Col lg={3}>
            <div>
              ...
              <div className="d-flex pt-2">
                <div className="socialicons_hover transition cursor_pointer linear_bg_orange border_radius_50 p-2 h_w_footer_linear d-flex justify-content-center align-items-center">
                  <img src={socialicon1} alt="discord" className="w-100" />
                </div>
                <div className="socialicons_hover transition cursor_pointer linear_bg_orange ms_12 border_radius_50 p-2 h_w_footer_linear d-flex justify-content-center align-items-center">
